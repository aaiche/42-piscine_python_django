...
echo "source ~/.zshrc"
source ~/.zshrc
echo "virtualenv -p /Users/aaiche/.brew/bin/python3 d04_env"
virtualenv -p /Users/aaiche/.brew/bin/python3 d04_env
echo "source d04_env/bin/activate"
source d04_env/bin/activate
