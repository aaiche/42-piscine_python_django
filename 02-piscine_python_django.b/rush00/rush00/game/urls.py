...
urlpatterns = [
    ...
    path('moviedex/<slug:moviemon>', views.details, name="details"),
    path('battle/<slug:moviemon>', views.battle, name="battle"),
    path('battle_A/<slug:moviemon>', views.battle_A, name="battle_A"),

    url(r'^.*', views.notfound, name='unmatched')
]
